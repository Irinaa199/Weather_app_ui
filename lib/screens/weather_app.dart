...
import 'package:weather_application/models/weather_locations.dart';
import 'package:weather_application/widgets/buildin_transformer.dart';
import 'package:weather_application/widgets/single_weather.dart';
import 'package:weather_application/widgets/slider_dot.dart';
        ...
        child: Stack(
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  for (int i = 0; i < locationList.length;)
